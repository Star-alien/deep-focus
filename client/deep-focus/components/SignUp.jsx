      ...
      <div className='login-section'>
        ...
        <div className='login-form grid mx-32'>
          <div className='my-5 p-3'>
            <h1 className='text-xl text-[#292C38] '><b>Create Account to Get Started</b></h1>
            <p className='space-x-1 text-[#73778B]'>Sign up and get started</p>
          </div>
          <GoogleSignIn />
          ...
          <div className='text-[#73778B] mt-3'>Have an account already? <a className='text-[#3980ED] cursor-pointer'><b>Sign In</b></a></div>
        </div>
      </div>
      <div className='blue'>
